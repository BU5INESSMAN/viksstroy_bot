...
class ApplicationNumberHelpersTest(unittest.TestCase):
    def test_short_number_format_and_fallback(self):
        self.assertEqual(make_application_number("260804", 1), "З-260804-01")
        self.assertEqual(make_application_number("260804", 113), "З-260804-113")
        self.assertEqual(display_application_number(1034, "З-260804-17"), "З-260804-17")
