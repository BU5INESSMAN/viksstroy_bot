...
EVENTS = {
    ...
    "role_changed": ("Сотрудники", "Изменение моей роли", {"worker", "driver", "brigadier", "foreman", "moderator", "boss", "hr"}),
    ...
    "support_reply": ("Поддержка", "Ответ поддержки", {"worker", "driver", "brigadier", "foreman", "moderator", "boss", "superadmin", "hr"}),
    "broadcast": ("Общее", "Сообщения руководства", {"worker", "driver", "brigadier", "foreman", "moderator", "boss", "superadmin", "hr"}),
    "notification_test": ("Общее", "Тестовые уведомления", {"worker", "driver", "brigadier", "foreman", "moderator", "boss", "superadmin", "hr"}),
