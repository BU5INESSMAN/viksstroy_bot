                            ...
                            <div className="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-800 dark:to-blue-900 px-6 py-8 text-white relative">
                                ...
                                <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
                                    ...
                                    <div className="text-center sm:text-left">
                                        ...
                                        <p className="text-blue-200 uppercase tracking-wide text-sm font-semibold mt-1">{roleNames[profileData.role] || profileData.role}</p>
                                    </div>
                                </div>
                            </div>

                            {profileData.unregistered ? (
                                <div className="p-8 text-center bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700 mt-4 mx-6 mb-6">
                                    <span className="text-5xl mb-4 block">📴</span>
                                    <h4 className="text-xl font-bold text-gray-800 dark:text-white mb-2">Аккаунт не привязан</h4>
                                    <p className="text-gray-500 dark:text-gray-400 text-sm">Этот сотрудник был добавлен в систему, но еще ни разу не авторизовался и не привязал свой мессенджер.</p>
                                </div>
                            ) : (
