...
import {
    User, Pencil, Send, MessageCircle, Star, Settings, ChevronDown,
...
/**
 * DriverCard — single driver tile on the Resources / Водители tab.
 * Visual language: GlassCard-style border, soft hover lift, no harsh borders.
 */
export default function DriverCard({ driver, canManage, onEdit, onDelete, onRegenerateInvite, onShowInvite }) {
    const [showMenu, setShowMenu] = useState(false);
    const fio = displayFio(driver);

    const isLinked = driver.linked || driver.tg_id || driver.max_id;
    const pending = driver.pending_redeem;
