            ...
            {role === 'superadmin' && (
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700 transition-colors duration-200">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <button onClick={() => handleTestRole('moderator')} className="px-4 py-2 bg-indigo-50 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400 rounded-lg font-bold hover:bg-indigo-100 transition">Модератор</button>
                        <button onClick={() => handleTestRole('foreman')} className="px-4 py-2 bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 rounded-lg font-bold hover:bg-blue-100 transition">Прораб</button>
                        <button onClick={() => handleTestRole('worker')} className="px-4 py-2 bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-400 rounded-lg font-bold hover:bg-green-100 transition">Рабочий бригады</button>
                        <button onClick={() => handleTestRole('driver')} className="px-4 py-2 bg-yellow-50 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400 rounded-lg font-bold hover:bg-yellow-100 transition">Водитель техники</button>
                    </div>
                </div>
            )}
