...
export default function Teams() {
    ...
    const handleDeleteMember = async (memberId) => { if(!window.confirm('Удалить?')) return; try { const fd = new FormData(); fd.append('tg_id', tgId); await axios.post(`/api/teams/members/${memberId}/delete`, fd); const res = await axios.get(`/api/teams/${manageTeamData.id}/details`); setManageTeamData(res.data); fetchData(); } catch (err) { alert("Ошибка"); } };
