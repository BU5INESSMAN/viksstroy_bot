    ...
    return (
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            <div className="flex space-x-2 mb-6 overflow-x-auto pb-2">
                <button onClick={() => setActiveTab('list')} className={`px-5 py-2.5 rounded-xl font-bold whitespace-nowrap transition-colors ${activeTab === 'list' ? 'bg-blue-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:bg-gray-50'}`}>📋 Список техники</button>
                {canManageFull && (<><button onClick={() => setActiveTab('add_single')} className={`px-5 py-2.5 rounded-xl font-bold whitespace-nowrap transition-colors ${activeTab === 'add_single' ? 'bg-blue-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:bg-gray-50'}`}>➕ Добавить одну</button><button onClick={() => setActiveTab('add_bulk')} className={`px-5 py-2.5 rounded-xl font-bold whitespace-nowrap transition-colors ${activeTab === 'add_bulk' ? 'bg-blue-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:bg-gray-50'}`}>📦 Массовая загрузка</button></>)}
            </div>
