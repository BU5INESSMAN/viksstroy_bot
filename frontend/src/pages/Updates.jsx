...
const versions = [
    {
        ...
        changes: [
            ...
            { type: 'fix', text: 'Исправлена ошибка создания техники (405)' },
            { type: 'fix', text: 'Уведомления в Telegram теперь работают через прокси' },
            { type: 'feat', text: 'Страница обновления при перезапуске сервера' },
            { type: 'feat', text: 'Сессия сохраняется в браузере' },
        ],
    },
    {
