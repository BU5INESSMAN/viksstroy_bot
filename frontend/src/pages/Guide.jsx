            ...
            content: (
                <>
                    ...
                    <ol className="list-decimal ml-5 space-y-1.5">
                        <li><b>Часы и ЗП участников</b> — укажите отработанное время для каждой бригады. Значение часов на уровне бригады подставится всем сотрудникам; можно развернуть бригаду и задать часы конкретному человеку. Прораб отдельно вписывает фактическую ЗП каждого участника — она не смешивается с расценками работ. Сотрудники в отпуске/на больничном отмечены бейджем.</li>
