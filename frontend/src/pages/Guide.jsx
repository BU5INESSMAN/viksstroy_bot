...
export default function Guide() {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="mb-3">В системе 8 рабочих ролей. Набор вкладок и уведомлений формируется под задачи каждой роли.</p>
                    <p><b>Отдел кадров:</b> использует рабочие вкладки «Объекты», «Ресурсы» и «СМР». Может менять состав бригад, данные и статусы сотрудников и водителей, видеть цены и суммы СМР, проверять отчёты и создавать допотчёты. Главная, модерация заявок и системная админка для этой роли скрыты.</p>
                    <RoleTable />
                </>
            ),
        },
