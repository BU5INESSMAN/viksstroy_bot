        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Кадры:</b> используют рабочие вкладки «Объекты», «Ресурсы» и «СМР». Могут менять состав бригад, данные и статусы сотрудников и водителей, видеть цены и суммы СМР, проверять отчёты и создавать допотчёты. Главная, модерация заявок и системная админка для этой роли скрыты.</p>
                    <RoleTable />
                </>
            ),
        },
