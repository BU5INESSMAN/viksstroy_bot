    ...
    const sections = [
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Офисные роли (v2.7.1):</b> Роли модератор / босс / суперадмин по паролю больше не выдаются — их назначает действующий суперадмин.</p>
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Ответ через бота (v2.11):</b> Кнопки принятия и отклонения работают и в Telegram, и в MAX. После ответа бот подтверждает результат, а система уведомляет участников обмена.</p>
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Каналы и события независимы:</b> можно, например, оставить СМР в Telegram, отключить отдельное напоминание и полностью выключить MAX. Одинаковые настройки действуют для сообщений и центра уведомлений.</p>
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="mb-3">В системе 8 рабочих ролей. Набор вкладок, уведомлений и содержимое главной страницы формируются под задачи каждой роли.</p>
