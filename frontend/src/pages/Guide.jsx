...
export default function Guide() {
    ...
    const sections = [
        ...
        },
        {
            ...
            keywords: 'смр кп выполненные работы отчёт заполнение часы работы мастер wizard бригадир прораб проверка одобрение excel экспорт справочник должники напоминания группировка объект дата',
            content: (
                <>
                    ...
                    <ol className="list-decimal ml-5 space-y-1.5">
                        ...
                        <li><b>Работы</b> — укажите объёмы выполненных работ из плана объекта. Единицы измерения (шт, м, м², т и др.) отображаются рядом с каждой позицией. Дополнительные работы выбираются из каталога КП через раскрываемый список с поиском по категориям.</li>
                    ...
                    <ul className="list-disc ml-5 space-y-1">
                        ...
                        <li>Если несколько бригадиров работают над одной заявкой, каждый следующий видит, кто и когда заполнил ранее.</li>
                    </ul>
                    <p><b>Страница «СМР»:</b> заявки сгруппированы по объекту, внутри объекта — по датам. На вкладке «Готовые» рядом с каждой заявкой — кнопка <b>«Скачать»</b>.</p>
                    ...
                    <Tip>Время открытия СМР настраивается администратором в разделе «Админка» → «Настройка СМР».</Tip>
                </>
            ),
        },
        {
