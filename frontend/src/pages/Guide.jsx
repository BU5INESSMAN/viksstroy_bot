        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Откуда берутся цены:</b> при заполнении система сохраняет в строке отчёта снимок актуальной расценки из справочника. Поэтому последующая загрузка нового прайса не изменяет старые отчёты. В файле справочника цена берётся из колонки C листа «СМР», расценка ЗП — из H, единица — из G. Пустые, отрицательные и некорректные значения отклоняются; формула «ЗП × 4» больше не применяется.</p>
