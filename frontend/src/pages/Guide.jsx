        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p>Прораб получает <b>одно сводное уведомление</b> о правках модератора со списком изменённых полей (без значений до/после — конкретику видно в самой заявке). Водители при правках на этапе проверки уведомлений не получают: их уведомят один раз при публикации с финальным составом расстановки.</p>
                </>
            ),
        },
        {
