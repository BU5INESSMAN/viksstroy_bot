        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Вкладка «Готовые»:</b> рядом с каждой заявкой есть кнопка <b>«Скачать»</b>. Имя файла отчёта: <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">Объект - Номер заявки - ДД.ММ.ГГГГ.xlsx</code>.</p>
