...
export default function Guide() {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Архивация:</b> Завершённые заявки можно отправить в архив кнопкой "В архив" на карточке.</p>
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Приглашение участников:</b> Для каждой бригады генерируется уникальный код и ссылка-приглашение. Отправьте ссылку рабочим.</p>
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p><b>Привязка водителя:</b> Генерируется код приглашения. Водитель присоединяется по ссылке или команде /join.</p>
        ...
        },
        {
            ...
            content: (
                <>
                    <p><b>Создание:</b> Страница "Объекты" → "Создать объект". Укажите название, адрес.</p>
                    ...
                    <p><b>PDF-смета:</b> Загрузите PDF-файл сметы — система извлечёт из него позиции для справочника КП.</p>
                    <p><b>Архивация:</b> Неактуальные объекты можно архивировать и позже восстановить.</p>
                    <p><b>Запрос на создание:</b> Прорабы могут запрашивать создание нового объекта — модератор одобрит или отклонит.</p>
                </>
            ),
        },
        {
